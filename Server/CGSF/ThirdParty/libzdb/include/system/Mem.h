 ...
 * @hideinitializer
 */
#define ALLOC(n) Mem_alloc((n), __FUNCTION__, __FILE__, __LINE__)
 ...
 * @hideinitializer
 */
#define CALLOC(c, n) Mem_calloc((c), (n), __FUNCTION__, __FILE__, __LINE__)
 ...
 * @hideinitializer
 */
#define FREE(p) ((void)(Mem_free((p), __FUNCTION__, __FILE__, __LINE__), (p) = 0))
 ...
 * @hideinitializer
 */
#define RESIZE(p, n) ((p)= Mem_resize((p), (n), __FUNCTION__, __FILE__, __LINE__))
